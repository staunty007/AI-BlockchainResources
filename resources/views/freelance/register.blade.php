   ...
   <body>
      ...
      <main class="page-sign container container-palette">
         <div class="container">
            <div class="sign-form">
               <div class="header">
                  <h1 class="title">Freelance Registration</h1>
               </div>
               ...
               <form action="{{ route('freelance.register') }}" class="job-sign-from" method="POST">
                {{ csrf_field() }}
                <div class="row">
                  <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="phone" placeholder="Phone Number" name="phone" class="form-control" value="{{ old('phone') }}"/>
                </div>
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-custom btn-custom-secondary" value="Register as Freelance">
                </div>
               </form>
