        ...
        <td  style="padding:50px;" class="mui-panel">
          <center>
            ...
            <div class="mui-divider-bottom"></div>
              ...
              Welcome {{ $freelancer->name . " " . $freelancer->lastname }} - <br><br>
              To verify your Email ..click on the button below for full Access.. Thanks.</p>
              <button class="btn btn-lg btn-primary"><a href="{{ route('sendFreelancerEmailDone',["email" => $freelancer->email,"verifyToken" => $freelancer->verifyToken]) }}">Verify Email</a></button>
              <br><br>
              </div>
